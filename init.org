...
#+begin_src emacs-lisp
  (use-package evil-nerd-commenter
    :commands (evilnc-copy-and-comment-lines evilnc-comment-or-uncomment-lines evilnc-comment-or-uncomment-paragraphs evilnc-quick-comment-or-uncomment-to-the-line)
    :config
