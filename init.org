...
#+begin_src emacs-lisp
  (use-package eglot
    ...
    (add-hook 'eglot-managed-mode #'(lambda () (add-hook 'after-save-hook 'sergio/eglot-auto-format nil t)))
    (add-hook 'eglot-managed-mode-hook (lambda () (setq completion-at-point-functions '(eglot-completion-at-point python-completion-at-point cape-file t))))
